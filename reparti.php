                      ...
                      <?php
                        if($result->num_rows==0) {
                          ...
                          while($row = $result->fetch_array()) {
                            ...
                            echo "<td>" . $row['ID'] . "</td>";
                            echo "<td>" . $row['Nome'] . "</td>";
                            echo "<td><a href='reparti.php?edit_id=".$row['ID']."' class='btn btn-default btn-sm'>modifica</a> ";
                            echo "<a href='reparti.php?delete_id=".$row['ID']."' class='btn btn-danger btn-sm'>cancella</a></td>";
                            echo "</tr>";
                         }
                        }
                      ?>
